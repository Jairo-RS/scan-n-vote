  ...
  Future<bool> _onBackPressed() {
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("¿Desea desconectarse de su cuenta?"),
        actions: <Widget>[
          TextButton(
          ...
          appBar: AppBar(
            actions: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  var _currentAssembly = Assemblies.fetchAssemblies();
                  setState(() {
                    futureAssembly = _currentAssembly;
                  });
                },
              ),
            ],
